      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-between">
          <div className="flex flex-row justify-between flex-grow">
            ...
            <div>
              <h6 className="text-gray-400 font-bold uppercase">Support</h6>
              <ul className="text-xs">
                <li>Payments</li>
                <li>Contact</li>
              </ul>
          ...
          <div className="flex items-center mb-4 lg:mb-0">
            ...
            {/* Logo should go here */}
            <p className="text-xs text-gray-400 ml-4">Proudly built in Sweden</p>
          </div>
        </div>
        <div className="text-center text-gray-400 text-xs mt-8 lg:mt-4">
          ...
          <p className="mt-4 lg:mt-0">Copyright &copy; 2023 PXB MEDIA. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
